...
LINK_ACCESSIBILITY_PASSWORD = "password"  # accessible by anyone with link who knows password
LINK_ACCESSIBILITY_DOMAIN = "domain"  # accessible by any domain user (login required)
LINK_ACCESSIBILITY_RECIPIENTS = "recipients"  # accessible by link recipients, who must be domain users (login required)
